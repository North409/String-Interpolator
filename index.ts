...
type TrimWhiteSpace<Str extends string> = 
  string extends Str
  ? "Error"
...
type CheckTypes<Str extends string, Obj extends string> = 
  string extends Str 
  ...
  TrimWhiteSpace<Var> extends Obj 
      ...
      : Var // ParserError<`{{${Var}}} does not exists on the given object`>
    : true

type Interpolate<Str extends string, Obj extends Record<string, string>> = 
  string extends Str
